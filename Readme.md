# StateRestore for DataTables with Bootstrap 3 styling
...
Installation from NPM can be done with the `datatables.net-staterestore-bs` package:

```
npm install \
    datatables.net-bs \
    datatables.net-buttons-bs \
    datatables.net-staterestore-bs
```
